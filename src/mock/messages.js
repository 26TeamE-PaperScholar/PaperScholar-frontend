...
export const mockMessages = {
  received: [
    {
      id: 'M-001',
      sender: { id: 'sys', display_name: 'PaperScholar 系统', display_name_key: 'mock_message_sender_system' },
      title: '欢迎来到 PaperScholar',
      title_key: 'mock_message_welcome_title',
      content: '感谢使用 PaperScholar 学术检索平台。我们已为您预加载了 18 篇精选论文与 10 余位关注学者，开始探索吧。',
      content_key: 'mock_message_welcome_content',
    ...
    },
    {
      ...
      title_key: 'mock_message_follow_title',
      content: '《Large Language Models as Research Assistants: A Survey》已收录，点击查看详情。',
      content_key: 'mock_message_follow_content',
    ...
    },
    {
      ...
      title: '感谢您的关注',
      title_key: 'mock_message_private_title',
      content: '欢迎一同探讨 retrieval-augmented research workflow，欢迎邮件交流。',
      content_key: 'mock_message_private_content',
    ...
    {
      id: 'M-004',
      sender: { id: 'sys', display_name: 'PaperScholar 审核', display_name_key: 'mock_message_sender_audit' },
      title: '身份认证已通过',
      title_key: 'mock_message_audit_title',
      content: '您提交的身份认证申请已审核通过，欢迎使用学者主页与高级检索功能。',
      content_key: 'mock_message_audit_content',
    ...
    },
    {
      ...
      sender: { id: 'sys', display_name: 'PaperScholar 系统', display_name_key: 'mock_message_sender_system' },
      title: '本周学术热点摘要',
      title_key: 'mock_message_hot_title',
      content: '为您推送本周内您关注方向（信息检索 · 图神经网络）的 5 篇精选工作。',
      content_key: 'mock_message_hot_content',
